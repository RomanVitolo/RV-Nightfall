...
namespace Modules.Multiplayer.Bridge.EditorTools
{
    ...
    {
        private const string ModuleRoot = "Assets/Modules/Multiplayer";

        internal const string LobbyScenePath = ModuleRoot + "/Scenes/LobbyScene.unity";
        internal const string RootPrefabPath = ModuleRoot + "/Prefabs/MultiplayerRoot.prefab";
        private const string LobbyUiPrefabPath = ModuleRoot + "/Prefabs/LobbyUI.prefab";
        internal const string NetworkPrefabsListPath = "Assets/DefaultNetworkPrefabs.asset";

        private const string UiFolder = ModuleRoot + "/UI";
        ...
        internal static void AssignPlayerPrefab(GameObject playerPrefab, StringBuilder report)
        {
            ...
            {
                report.AppendLine("Lobby not set up yet; run Tools > Multiplayer > Set Up Lobby so players can spawn.");
                return;
            }
        ...
        private static bool Execute()
        {
            ...
            if (playerPrefab == null)
            {
                Debug.LogError($"Lobby Setup aborted: no player prefab at {PlayerAssetLookup.PlayerPrefabPath}. " +
                               "Run Tools > Multiplayer > Set Up Networked HEROPLAYER first.");
                return false;
            }

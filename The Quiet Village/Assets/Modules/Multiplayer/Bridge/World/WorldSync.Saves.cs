...
using Modules.Multiplayer.Bridge.Saves;
...
namespace Modules.Multiplayer.Bridge.World
{
    ...
    /// </remarks>
    public partial class WorldSync : Modules.Multiplayer.Scripts.Runtime.Flow.ISpawnGate
    {
        ...
        private void OnSavesSpawn()
        {
            if (IsServer)
            {
                ...
                Modules.Multiplayer.Scripts.Runtime.Flow.SpawnGate.Active = this;
        ...
        {
            var sessions = FindAnyObjectByType<Modules.Multiplayer.Scripts.Runtime.Sessions.SessionService>();

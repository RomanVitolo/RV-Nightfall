...
namespace Modules.Multiplayer.Scripts.Runtime.Levels
{
    /// <summary>
    ...
    /// a name even in different folders. Tools > Multiplayer > Levels keeps this list and Build Settings in step.
    /// </remarks>

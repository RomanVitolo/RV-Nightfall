...
namespace QuietVillage.Multiplayer.Bridge.World
{
    ...
    /// Tools > Quiet Village > Multiplayer > Set Up World Sync. That makes it identical in every build of the same scene, and
    ...
    {
        [Tooltip("Identity shared by every client. Written by Tools > Quiet Village > Multiplayer > Set Up World Sync — do not edit.")]

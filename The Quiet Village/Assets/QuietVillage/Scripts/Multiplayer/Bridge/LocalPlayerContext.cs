...
namespace QuietVillage.Multiplayer.Bridge
{
    ...
    public static class LocalPlayerContext
    {
        ...
        private static DialogueSystem s_dialogueSystem;
        private static ObjectiveManager s_objectiveManager;
        ...
        /// <summary>Plays dialogue and subtitles for this client, or <c>null</c> before the player spawns.</summary>
        /// <remarks>
        /// Use this rather than <c>DialogueSystem.Instance</c>. That singleton lookup throws while no player exists, and
        /// once several do it returns the first it finds, which can be a teammate's switched-off copy.
        /// </remarks>
        public static DialogueSystem DialogueSystem => s_dialogueSystem != null ? s_dialogueSystem : null;

        /// <summary>This client's objectives, or <c>null</c> before the player spawns.</summary>
        /// <remarks>See <see cref="DialogueSystem"/>: the same applies to <c>ObjectiveManager.Instance</c>.</remarks>
        public static ObjectiveManager ObjectiveManager => s_objectiveManager != null ? s_objectiveManager : null;
        ...
        public static void Bind(GameObject localPlayer)
        {
            ...
            s_dialogueSystem = localPlayer.GetComponentInChildren<DialogueSystem>(true);
            s_objectiveManager = localPlayer.GetComponentInChildren<ObjectiveManager>(true);
        ...
        private static void WarnIfMissing(Component component, string name)
        {
            ...
            Debug.LogError(
                ...
                "Re-run Tools > Quiet Village > Multiplayer > Set Up Networked HEROPLAYER to put the managers on the prefab.");
        }
    }
}

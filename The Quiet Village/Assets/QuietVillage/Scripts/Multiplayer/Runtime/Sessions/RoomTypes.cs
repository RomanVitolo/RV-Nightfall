...
namespace QuietVillage.Multiplayer.Sessions
{
    ...
    public readonly struct RoomMember
    {
        ...
        /// <summary>The character they show the room, encoded; empty if they have not published one.</summary>
        public readonly string Character;

        public RoomMember(string id, string displayName, bool isHost, bool isLocal, string character = "")
        {
            Id = id;

...
namespace UHFPS.Runtime
{
    public class TimedInteractEvent : MonoBehaviour, IInteractStart, IInteractStop, IInteractTimed, ISaveable
    {
        ...
        public bool ContainsRequiredItem => !RequireInventoryItem || LocalPlayerContext.Inventory.ContainsItem(RequiredItem);
        ...
        public void InteractStart()
        {
            if (ShowRequireItemHint && !ContainsRequiredItem)
                LocalPlayerContext.GameManager.ShowHintMessage(HintMessage, HintMessageTime);

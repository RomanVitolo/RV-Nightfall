...
namespace UHFPS.Runtime
{
    ...
    public class GeneratorFuelTank : MonoBehaviour, IInteractStart, IInteractStop, IInteractTimed
    {
        ...
        public bool NoInteract
        {
            get
            {
                if ((LocalPlayerContext.Inventory != null))
                    return !canRefuel || !LocalPlayerContext.Inventory.ContainsItem(FuelItem);
        ...
        public void InteractStart()
        {
            ...
            if (LocalPlayerContext.Inventory.ContainsItemMany(FuelItem, out var items))
            {

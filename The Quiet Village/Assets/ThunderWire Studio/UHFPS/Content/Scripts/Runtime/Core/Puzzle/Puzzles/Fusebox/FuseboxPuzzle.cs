...
namespace UHFPS.Runtime
{
    ...
    public class FuseboxPuzzle : PuzzleBaseSimple, IInventorySelector, ISaveable
    {
        ...
        public override void InteractStart()
        {
            ...
            if(!UseInteract) LocalPlayerContext.Inventory.OpenItemSelector(this);
            else
            {
                InventoryItem fuseItem = LocalPlayerContext.Inventory.GetInventoryItem(FuseItem);
        ...
        private void InsertFuse(InventoryItem fuseItem)
        {
            ...
            LocalPlayerContext.Inventory.RemoveItem(fuseItem, (ushort)inserted);

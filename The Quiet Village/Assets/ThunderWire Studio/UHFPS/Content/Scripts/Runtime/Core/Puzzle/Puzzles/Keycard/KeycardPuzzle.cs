...
namespace UHFPS.Runtime
{
    ...
    public class KeycardPuzzle : PuzzleBaseSimple, IInventorySelector, ISaveable
    {
        ...
        public override void InteractStart()
        {
            ...
            {
                InventoryItem keycardItem = LocalPlayerContext.Inventory.GetInventoryItem(KeycardItem);
        ...
        private void UpdateKeycardState(InventoryItem item, bool state)
        {
            if (state)
            {
                ...
                if (RemoveKeycardAfterUse) LocalPlayerContext.Inventory.RemoveItem(item);

...
namespace UHFPS.Runtime
{
    public class CutsceneTrigger : MonoBehaviour, IInteractStart, ISaveable
    {
        ...
        {
            if (!DrawCutEndGizmos || BlendDefinition.Style != CinemachineBlendDefinition.Styles.Cut || CutEndTransform == null || !(LocalPlayerContext.Presence != null))
                return;

            CharacterController controller = LocalPlayerContext.Presence.StateMachine.PlayerCollider;
